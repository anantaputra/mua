                ...
                <div class="col-lg-6 animated fadeIn">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid bg-white p-3 w-100 mb-3" src="img/img-11.jpg" alt="">
                            <img class="img-fluid bg-white p-3 w-100" src="img/img-12.jpg" alt="">
                        </div>
                        <div class="col-6">
                            <img class="img-fluid bg-white p-3 w-100 mb-3" src="img/img-13.jpg" alt="">
                            <img class="img-fluid bg-white p-3 w-100" src="img/gmb-4.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="row g-3 img-twice position-relative h-100">
                        <div class="col-6">
                            <img class="img-fluid bg-light p-3" src="img/img-7.jpg" alt="">
                        </div>
                        <div class="col-6 align-self-end">
                            <img class="img-fluid bg-light p-3" src="img/img 10.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <div class="row g-2 mb-4">
                            <div class="col-sm-6">
                                <i class="fa fa-check text-primary me-3"></i>Produk Kualitas
                            </div>
                            <div class="col-sm-6">
                                <i class="fa fa-check text-primary me-3"></i>Memilih Produk
                            </div>
                            <div class="col-sm-6">
                                <i class="fa fa-check text-primary me-3"></i>Pesan Online
                            </div>
                            <div class="col-sm-6">
                                <i class="fa fa-check text-primary me-3"></i>Datang Lokasi
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-xxl bg-light py-5 my-5" id="paket">
        <div class="container py-5">
            ...
            <div class="row g-3">
                ...
                @if($no % 2 == 0)
                <div class="col-lg-3 col-md-6 pt-lg-5 wow fadeInUp" data-wow-delay="0.{{ $dur == 1 ? $dur : $dur + 2 }}s">
                ...
                @else
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.{{ $dur == 1 ? $dur : $dur + 2 }}s">
                    <div class="service-item d-flex flex-column bg-white p-3 pb-0">
                        <div class="position-relative">
                            <img class="img-fluid" src="{{ asset('paket/'.$item->gambar) }}" alt="">
                            <div class="service-overlay">
            ...
            <div class="row g-3">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="img/gmb-5.jpeg" alt="">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="img/gmb-6.jpeg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="img/img-10.jpg" alt="">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="img/gmb-4.jpeg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="img/gmb-1.jpeg" alt="">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="img/gmb-3.jpeg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="project-item">
                                <img class="img-fluid" src="img/gmb-2.jpeg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
